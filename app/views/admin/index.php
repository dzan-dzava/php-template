...
<head>
  ...
  <title><?php echo $appInfo->SiteName; ?> - მთავარი</title>
  ...
  <![endif]-->
  <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>assets/admin/lib/jquery.vectormap/jquery-jvectormap-1.2.2.css"/>
  <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>assets/admin/lib/jqvmap/jqvmap.min.css"/>
...
<body>
            ...
            <div class="panel panel-default panel-table">
              ...
              <div class="panel-body table-responsive">
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td class="user-avatar"> <img src="<?php echo $baseUrl; ?>assets/admin/img/avatar6.png" alt="Avatar">Penelope Thornton</td>
                      <td>Topbar dropdown style</td>
                      <td>Aug 16, 2016</td>
                      <td class="actions"><a href="#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                    </tr>
                    <tr>
                      <td class="user-avatar"> <img src="<?php echo $baseUrl; ?>assets/admin/img/avatar4.png" alt="Avatar">Benji Harper</td>
                      <td>Left sidebar adjusments</td>
                      <td>Jul 15, 2016</td>
                      <td class="actions"><a href="#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                    </tr>
                    <tr>
                      <td class="user-avatar"> <img src="<?php echo $baseUrl; ?>assets/admin/img/avatar5.png" alt="Avatar">Justine Myranda</td>
                      <td>Main structure markup</td>
                      <td>Jul 28, 2016</td>
                      <td class="actions"><a href="#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                    </tr>
                    <tr>
                      <td class="user-avatar"> <img src="<?php echo $baseUrl; ?>assets/admin/img/avatar3.png" alt="Avatar">Sherwood Clifford</td>
  ...
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-flot/jquery.flot.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-flot/jquery.flot.pie.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-flot/jquery.flot.resize.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-flot/plugins/jquery.flot.orderBars.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-flot/plugins/curvedLines.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery.sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/countup/countUp.min.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jqvmap/jquery.vmap.min.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/lib/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
  <script src="<?php echo $baseUrl; ?>assets/admin/js/app-dashboard.js" type="text/javascript"></script>
